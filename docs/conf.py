# -*- coding: utf-8 -*-
#
# oocgcm documentation build configuration file, created by
...
# add these directories to sys.path here. If the directory is relative to the
# documentation root, use os.path.abspath to make it absolute, like shown here.
#sys.path.insert(0, os.path.abspath('../oocgcm/'))
#sys.path.append(os.path.abspath('../oocgcm'))
sys.path.append(os.path.join(os.path.abspath(os.pardir),'xscale'))
...
project = u'xscale'
copyright = u'2016, xscale developpers'
...
latex_documents = [
  ('index', 'xscale.tex', u'xscale Documentation',
   u'xscale developpers', 'manual'),
]
...
texinfo_documents = [
  ('index', 'xscale', u'xscale Documentation',
   u'xscale developpers', 'xscale', 'One line description of project.',
   'Miscellaneous'),
]
