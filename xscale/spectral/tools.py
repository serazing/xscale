...
def plot_spectrum(spectrum, freqs=None, ax=None, xlog=False, ylog=False,
                  loglog=False, variance_preserving=False, xlim=None,
...
def _plot_spectrum1d(x, y, ax=None, **kwargs):
	"""
	Define a nice spectrum with twin x-axis, one with frequencies, the
